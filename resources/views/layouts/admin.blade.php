      ...
      <div class="container-fluid">
        <div class="wrap">
          <div class="row">
            <div class="col-lg-3">
              <div class="imghdr">
                <svg widht="100%" height="75" xmlns:xlink="#">
                  <a xlink:href="#">
                    <text x="0" y="70%"
                    style="font-size:50px;font-weight:900;stroke:orange;font-style:italic;fill:grey;cursor:pointer;">
                    RiZAVA
                  </text>
                </a>
              </svg>
          ...
          <div class="col-lg-3">
            <div class="side-nav">
              <ul class="nav nav-pills nav-stacked">
                <li class="active"><a href="{{ url('/admin') }}" class="list-group-item">Pending</a></li>
                <li><a href="{{ url('/admin/accept') }}" class="list-group-item">Accepted</a></li>
                <li><a href="{{ url('/admin/reject') }}"class="list-group-item">Rejected</a></li>
                <li><a href="{{ url('/admin/all') }}" class="list-group-item">ALL BOOKINGS</a></li>
              </ul>
            </div>
          </div>
